...
def main():
    ...
    print(f"Scanning: {LIBRISPEECH_DIR}")
                    ...
                    for line in f:
                        ...
                        try:
                            ...
                            if hyp_text_raw.startswith("Error"):
                                print(f"Skip {audio_filename}: {hyp_text_raw}")
                                continue

                            # =======================================================
                            # 【已注释】特定文件调试代码
                            # =======================================================
                            # if audio_filename == "7021-79740-0006.wav":
                            #     print("\n" + "!"*60)
                            #     print(f"【DEBUG 命中】正在检查文件: {audio_filename}")
                            #     print("-" * 30)
                            #     print(f"1. 数据集参考文本 (Ref): \n   {ref_text}")
                            #     print("-" * 30)
                            #     print(f"2. 模型识别文本 (Hyp): \n   {hyp_text_raw}")
                            #     print("-" * 30)
                            #     debug_ref_words = normalize_text(ref_text)
                            #     print(f"3. 参考文本单词个数 (Ref Word Count): {len(debug_ref_words)}")
                            #     print("!"*60 + "\n")
                            # =======================================================
